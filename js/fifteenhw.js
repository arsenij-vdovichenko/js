...
// const getSortedUniqueSkills = users => users.flatMap(({skills}) => skills).filtered((item, idx, arr) => arr.indexOf(item) === idx).sort((a, b) => a.localCompare(b))
...
const getSortedUniqueSkills = users => users.map(({skills}) => skills).filter((item, idx, arr) => arr.indexOf(item) === idx).sort((a, b) => a.localCompare(b))
